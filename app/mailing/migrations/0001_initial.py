    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=255, verbose_name="Operator Name"),
                ),
                (
                    "code",
                    models.CharField(max_length=255, verbose_name="Operator Code"),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=15,
                        unique=True,
                        validators=[mailing.validators.phone.validate_phone],
                    ),
                ),
                (
                    "time_zone",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, null=True, verbose_name="Message created at"
                    ),
                ),
                (
                    "client",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tag",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="mailing.tag"
                    ),
                ),
            ],
            options={
